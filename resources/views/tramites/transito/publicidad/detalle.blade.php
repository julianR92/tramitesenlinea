                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong>Estado de la solicitud:</strong><br>
                                    @if ($solicitud->estado_solicitud == 'REVISION-CONCEPTOS-SALUD')
                            ...
                            @if ($solicitud->estado_solicitud == 'PENDIENTE' || $solicitud->estado_solicitud == 'REVISION-CONCEPTOS')
                                <tr>
                                    ...
                                    @endif
                                    @if ($solicitud->estado_solicitud == 'REVISION-SALUD' && $solicitud->fecha_pendiente_planeacion != null)
                            ...
                            {{-- aqui va el form --}}
                            <form method="POST" action="{{ route('salud.publicidad.update') }}"
                                enctype="multipart/form-data" id="frmEstadoPublicidadSalud">
                                @csrf
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            <label for="adj_concepto_salud">Cargar Concepto Técnico</label>
                                            <input type="file" accept="application/pdf" name="adj_concepto_salud" required
                                                id="adj_concepto_salud"
                                                class="form-control @error('adj_concepto_salud') is-invalid @enderror">
                                            @error('adj_concepto_salud')
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <div class="form-group">
                                            ...
                                            <a href="{{ route('salud.publicidad.index') }}"
