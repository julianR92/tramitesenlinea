                        ...
                        <td><strong>Estado de la solicitud:</strong><br>
                            @if ($solicitud->estado_solicitud == 'ENVIADA')
                                        <p style="color: #069169;font-weight:bold">ENVIADA<span class="govco-icon govco-icon-check-p size-1x"></span></p>
                                         ...
                                         <p style="color: #F42E62;font-weight:bold">EN LEGAL Y DEBIDA FORMA<span class="govco-icon govco-icon-left-arrow-cn size-1x"></span></p>
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <select class="form-control  @error('estado_solicitud') is-invalid @enderror" name="estado_solicitud" id="estado_solicitud_discapacidad" required>
                                    ...
                                    <option value="RADICADA">EN LEGAL Y DEBIDA FORMA</option>
                        ...
                        <td colspan="2">
                            <div class="form-group">
                             <label for="observaciones">Observaciones*</label>
                                 <textarea name="observaciones_solicitud" id="observaciones_discapacidad" onkeypress="return Direccion(event)"  maxlength="500" class="form-control  @error('observaciones_solicitud') is-invalid @enderror"  cols="2" rows="3" required></textarea>
