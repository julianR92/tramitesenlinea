...
<style>
    ...
    <div class="container mt-3 mb-4 m-xs-x-3">
        ...
        <div class="col-md-12 pt-4">
            <h1 class="headline-xl-govco">Reportes PGIRH</h1>
            <div class="row pt-5">
                            ...
                            <div id="container_table" class="table-pagination-govco">
                                ...
                                <table id="DataTables_Table_0"
                                    ...
                                    <tr>
                                       ...
                                       <td><a href="http://pgirh.test/{{$reporte->ruta_acta_disposicion}}" target="_blank" class="btn-symbolic-govco" role="button">
                                       ...
                                       <td>
                                        <div class="btn-group" role="group">
                                            <a type="button" class="btn-symbolic-govco align-column-govco" href="{{route('salud.pgirh.detalle', ['id'=>$reporte->id, 'empresa'=>$reporte->razon_social, 'nit' => $reporte->nit, 'gestor'=>$reporte->gestor_residuos])}}">
