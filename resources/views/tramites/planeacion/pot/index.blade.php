                    ...
                    @endif 
                            ...
                            <div class="alert-primary-govco alert alert-dismissible fade show mt-3"
                                ...
                                <div class="alert-heading">
                                    ...
                                    <span class="headline-l-govco">Personas Opinando:</span>
                                </div>
                                <p class="text-center"><span class="step" id="conteo">{{$conteo}}</span></p>
                            </div>
                        </div>

                        <h3 class="headline-l-govco mt-3 pl-0">1. Datos Generales de la Encuesta</h3>
                        ...
                        <div class="row form-group mt-2">
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                                ...
                                <select name="barrio" id="barrio_pot"
                                    class="form-control @error('barrio') is-invalid @enderror barrios" required>
                                    <option value=""></option>
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                                ...
                                <select name="vereda" id="vereda"
                                    class="form-control @error('vereda') is-invalid @enderror barrios">
                                    <option value=""></option>
                                    @foreach ($veredas as $vereda)
                                    <option value="{{ $vereda->codigo }}"  {{ ($vereda->codigo == 0) ? 'selected' : '' }}>{{ $vereda->nombre }}</option>
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                                ...
                                <input value="{{ old('corregimiento', 'SIN INFORMACION') }}" type="text"
