            ...
            <div class="row pt-5">
                ...
                <div class="tabs-govco col-md-12 animate__animated animate__bounceInRight">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="respuestas-tab" data-toggle="tab" href="#respuestas" role="tab" aria-controls="home" aria-selected="true">Respuesta conceptos  <span class="badge badge-primary">{{$contador_revisadas}}</span></a>
                        </li>
                        ...
                        <div id="container_table" class="table-pagination-govco">
                            <table id="DataTables_Table_0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><strong>{{ $solicitudesRe->fecha_pendiente_planeacion }}</strong></p></td>
