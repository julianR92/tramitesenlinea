...
@section('dashboard')
    <div class="container mt-3 mb-4 m-xs-x-3">
        ...
        <div class="col-md-12 pt-4" style="padding-left: 10px!important">
            <h1 class="headline-xl-govco">Tablero de Intranet</h1>
            <div class="row pt-5">
    ...
    @push('reportes')
        ...
        <script>
            var ingresos = {!! json_encode($query, JSON_HEX_TAG) !!};
            var usuarios = {!! json_encode($query2, JSON_HEX_TAG) !!}; 
            console.log(ingresos,usuarios);        
            
            const ctx = document.getElementById('myChart').getContext('2d');
            const chart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: ['# Ingresos', '# Usuarios'],
                    datasets: [{
                        label: 'Portal Intranet',
                        data: [ingresos[0].ingresos, usuarios[0].usuarios],
                        borderColor: 'rgba(230, 239, 253, 1)' ,
                        backgroundColor: 'rgba(150, 30, 223, 1)'
                    }],
                },
                options: {
                    indexAxis: 'y', // <-- here
