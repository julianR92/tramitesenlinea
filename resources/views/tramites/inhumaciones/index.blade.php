        ...
        <div class="container-fluid">
            <div class="row mt-2">
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <form action="{{route('inhumaciones.search')}}" method="POST" id="myForm">
                        @csrf
                        <div class="card govco-card border-0 shadow-none" style="border-radius: 0px;">
                            ...
                            <p style="text-align: justify"> Este es el tramite de consulta de inhumaciones </p>
                        </div>

                        <h3 class="headline-l-govco mt-3 pl-0">1. Datos de consulta</h3>
                        ...
                        <div class="col-md-8 pl-1 pr-1 pt-3">
                            ...
                            <input value="{{old('email_solicitante')}}" type="mail" class="form-control email_validate @error('email_solicitante') is-invalid @enderror" name="email_solicitante" id="email_solicitante"  required>
                        ...
                        <div class="col-md-6 pl-1 pr-1 pt-3">
                            ...
                            <select class="form-control  @error('tipo_consulta') is-invalid @enderror" name="tipo_consulta" id="tipo_consulta" required>
                        ...
                        <div class="col-md-6 pl-1 pr-1 pt-3">
                            ...
                            <input value="{{old('numero_busqueda')}}" type="text" class="form-control document_validate  @error('numero_busqueda') is-invalid @enderror" name="numero_busqueda" id="numero_busqueda"  maxlength="15" minlength="4" required onkeypress="return NumDoc(event)" >
                        ...
                        <div class="col-md-12 pl-1 pr-1 pt-3 mt-3">
                         ...
                         <div class="col-md-12  pl-1 pr-1 pt-3 text-left mt-4" style="padding-left: 0px!important">
                            <button style="font-size:15px;" type="submit" class="btn btn-round btn-middle" name="consultar" onclick="return confirm('¿Esta seguro de realizar esta solicitud ?')">Realizar Consulta</button>
                         </div>
