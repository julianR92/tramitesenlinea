			...
			<div class="card-body bg-color-selago">
				<div class="container">
					<p class="form-inline my-0">
						...
						<a style="color: #3366CC;" href="mailto:cjguerrero@bucaramanga.gov.co"
							target="_blank"> cjguerrero@bucaramanga.gov.co</a>
					</p>
					<p class="form-inline">
						<span class="govco-icon govco-icon-call-center"></span>
						<a style="color: #3366CC;" href="tel:0376337000"> (+57)7 633 70 00 EXT 362</a>
					</p>
				</div>
			</div>
		</div>
