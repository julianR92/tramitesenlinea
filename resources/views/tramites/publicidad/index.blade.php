        ...
        <div class="container-fluid">
            <div class="row mt-2">
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <form action="{{route('parqueaderos.store')}}" method="POST" id="myForm" enctype="multipart/form-data" class="form-ciudadano">
                        @csrf
                        ...
                        <div class="row form-group mt-2">
                           <div class="col-md-12 pl-1 pr-1 pt-3">
                              <label for="modalidad_publicidad" class="form-label">Modalidad de publicidad * </label>

                              <select class="form-control  @error('modadalidad') is-invalid @enderror" name="modadalidad" id="modalidad_publicidad" required>
                                 <option value="">Seleccione</option>
                                 <option value="VALLAS">VALLAS COMERCIALES - PANTALLAS LED - TABLEROS ELECTRONICOS</option>
                                 <option value="AVISOS Y PENDONES">AVISOS Y PENDONES</option>
                                 <option value="MURALES ARTISTICOS">MURALES ARTISTICOS EN PROPIEDAD PRIVADA</option>
                                 <option value="PASACALLES PARA ENTIDADES PUBLICAS">PASACALLES PARA ENTIDADES PUBLICAS</option>
                                 <option value="PUBLICIDAD AEREA">PUBLICIDAD AEREA</option>
                                 <option value="PUBLICIDAD MOVIL">PUBLICIDAD MOVIL</option>
                             </select>
