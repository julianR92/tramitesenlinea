                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <select class="form-control  @error('tipo_publicidad') is-invalid @enderror"
                                name="tipo_publicidad" id="tipo_publicidad" required>
                                <option value="">Seleccione</option>
                        ...
                        <div class="d-none col-md-8" id="divRenovacion">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="fecha_renovacion" class="form-label">Fecha de
                                        renovación<code>*</code></label>
                                    <input type="date" value="{{ old('fecha_renovacion') }}"
                                        class="form-control  @error('fecha_renovacion') is-invalid @enderror"
                                        name="fecha_renovacion" id="fecha_renovacion" required>
