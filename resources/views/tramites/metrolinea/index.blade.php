                ...
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <form action="{{route('metrolinea.store')}}" method="POST" id="FormMetrolinea" enctype="multipart/form-data" class="form-ciudadano">
                        ...
                        <div class="card govco-card border-0 shadow-none" style="border-radius: 0px;">
                            ...
                            <h1 class="headline-xl-govco">Te llevamos en el corazón - Sistema de Transporte Público</h1>
                ...
                <label for="estado_civil" class="form-label">Estado Civil* <small style="font-size: 10px!important"><em style="font-size: 10px!important">(del solicitante)</em> </small> </label>
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                                ...
                                <select name="grupo_etnico" id="grupo_etnico"
                                    class="form-control @error('grupo_etnico') is-invalid @enderror" required>
                                    <option value="">Seleccione</option>
                                    @foreach ($grupos as $grupo)
                                        <option value="{{ $grupo->grupo_etnico }}">
                                            {{ $grupo->grupo_etnico }}</option>
                            ...
                            <div class="col-md-4 pl-1 pr-1 pt-3">
                                <label for="conflicto_armado" class="form-label">¿ Víctima Conflicto Armado? </label>
                                <select name="conflicto_armado" id="conflicto_armado"
                                    class="form-control @error('conflicto_armado') is-invalid @enderror" required>
                                    <option value="">Seleccione</option>
                                    <option value="SI">SI</option>
                                    <option value="NO">NO</option>                                    

                                </select>
                                @error('conflicto_armado')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                            ...
                            <div class="col-md-4 pl-1 pr-1 pt-3">
                                <label for="cabeza_familia" class="form-label">¿ Cabeza de familia? </label>
                                <select name="cabeza_familia" id="cabeza_familia"
                                    class="form-control @error('cabeza_familia') is-invalid @enderror" required>
                                    <option value="">Seleccione</option>
                                    <option value="SI">SI</option>
                                    <option value="NO">NO</option>                                    

                                </select>
                                @error('cabeza_familia')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                            ...
                            <div class="col-md-4 pl-1 pr-1 pt-3">
                                <label for="migrante" class="form-label">¿ Población migrante? </label>
                                <select name="migrante" id="migrante"
                                    class="form-control @error('migrante') is-invalid @enderror" required>
                                    <option value="">Seleccione</option>
                                    <option value="SI">SI</option>
                                    <option value="NO">NO</option>                                    
                          ...
                          <h3 class="headline-l-govco mt-3 pl-0">2. Documentos Adjuntos de la Solicitud <br> <span class="small-text-govco">*Campos obligatorios</span></h3>
                            ...
                            <div class="col-md-12 pl-1 pr-1 pt-3">
                                ...
                                <p class="pt-4 text-justify" ><b>Nota: &nbsp;</b> Si usted requiere ejercer sus derechos sobre la protección de datos, puede contactar a través de los siguientes correos: <a href="mailto:protecciondatos@bucaramanga.gov.co" href="_blank">protecciondatos@bucaramanga.gov.co</a> y/o <a href="mailto:jrueda@metrolinea.gov.co">jrueda@metrolinea.gov.co</a></p>
