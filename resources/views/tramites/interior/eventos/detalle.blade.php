                ...
                <div style="" class="table-simple-headblue-govco col-md-12 animate__animated animate__bounceInRight">              
                    ...
                    <tr>
                        <td><strong>Logistica del evento:</strong><br>
                            ...
                            <a href="http://tramitesenlinea.test/{{$solicitud->adj_logisticaEvento}}" target="_blank">Descargar documento</a>&nbsp;&nbsp;<i class="fa fa-download"></i>
                            @else
                        ...
                        <td><strong>Autorización de transito:</strong><br>
                            ...
                            <a href="http://tramitesenlinea.test/{{$solicitud->adj_autorizacionTra}}" target="_blank">Descargar documento</a>&nbsp;&nbsp;<i class="fa fa-download"></i>
                            @else
                            <small>No hay documento adjunto</small>
                            @endif
                        </td>
                    ...
                    <tr>
                        <td><strong>Documento de identificación:</strong><br>
                            <a href="http://tramitesenlinea.test/{{$solicitud->adj_cedulaRes}}" target="_blank">Descargar documento</a>&nbsp;&nbsp;<i class="fa fa-download"></i>
                        </td>

                        <td><strong>Contrato de arrendamiento:</strong><br>
                            <a href="http://tramitesenlinea.test/{{$solicitud->adj_contratoArr}}" target="_blank">Descargar documento</a>&nbsp;&nbsp;<i class="fa fa-download"></i>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><strong>Concepto Tecnico Sanitario y Ambiental:</strong><br>
                            <a href="http://tramitesenlinea.test/{{$solicitud->adj_conceptoTecAmb}}" target="_blank">Descargar documento</a>&nbsp;&nbsp;<i class="fa fa-download"></i>
                        </td>
                    ...
                    <tr>
                        <td><strong>Certificado MEBUC:</strong><br>
                            <a href="http://tramitesenlinea.test/{{$solicitud->adj_certificadoPONAL}}" target="_blank">Descargar documento</a>&nbsp;&nbsp;<i class="fa fa-download"></i>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><strong>Póliza de responsabilidad civil:</strong><br>
                            <a href="http://tramitesenlinea.test/{{$solicitud->adj_poliza}}" target="_blank">Descargar documento</a>&nbsp;&nbsp;<i class="fa fa-download"></i>
                        </td>
                    ...
                    {{-- aqui va el form --}}
                    <form class="myFormDefault" method="POST" action="{{route('interior.eventos.update')}}"  enctype="multipart/form-data" id="myForm_eventos">
                        @csrf
                    <tr>
                        <td>
                        ...
                        <td colspan="2">
                            <div class="form-group">
                             <label for="observaciones">Observaciones*</label>
                                 <textarea name="observaciones_solicitud" id="observaciones_eventos" onkeypress="return Observaciones(event)"  maxlength="500" class="form-control  @error('observaciones_solicitud') is-invalid @enderror"  cols="2" rows="4" required></textarea>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="form-group">
                                ...
                                <button type="submit"  onclick="return confirm('¿Esta seguro de generar esta respuesta ?')"  id="myBtn_eventos" class="btn btn-round btn-middle btn-outline-info" >Actualizar estado</button>
