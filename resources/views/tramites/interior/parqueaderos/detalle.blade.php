        ...
        <div class="col-md-12 pt-4" style="padding-left: 10px!important">
            ...
            <div class="row pt-5">
                ...
                <div style="" class="table-simple-headblue-govco col-md-12 animate__animated animate__bounceInRight">              
                    ...
                    @if($solicitud->adjunto_resPlaneacion != null)

                    <tr style="background-color:#004884">
                        <td colspan="3" style="background-color:#004884; color:white">Respuesta Técnica Planeación</td>
                    </tr>

                    <tr>
                        <td><strong>Viabilidad técnica:</strong><br>
                    ...
                    @if($solicitud->estado_solicitud == 'PENDIENTE' || $solicitud->estado_solicitud == 'REVISION-PLANEACION')
                    <tr>
                    ...
                    {{-- aqui va el form --}}
                    <form class="myFormDefault form-ciudadano" method="POST" action="{{route('interior.parqueaderos.update')}}"  enctype="multipart/form-data" id="myForm2">
                        @csrf
                    <tr>
                        <td>
                            <div class="form-group">
                                <label for="estado">Cambiar Estado de la solicitud*</label>
                                <select class="form-control  @error('estado_solicitud') is-invalid @enderror" name="estado_solicitud" id="estado_solicitud_parqueaderos" required>
                                    <option value="">Seleccione</option>
                                    <option value="PENDIENTE">DOCUMENTOS PENDIENTES</option>
                                    <option value="REVISION-PLANEACION">ENVIAR A PLANEACION</option>
                        ...
                        <td colspan="2">
                            <div class="form-group">
                             <label for="observaciones">Observaciones*</label>
                                 <textarea name="observaciones_solicitud" id="observaciones" onkeypress="return Direccion(event)"  maxlength="950" class="form-control  @error('observaciones_solicitud') is-invalid @enderror" id="observaciones" cols="2" rows="3" required></textarea>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="form-group">
                                ...
                                <button type="submit"  onclick="return confirm('¿Esta seguro de generar esta respuesta ?')"  id="myBtn" class="btn btn-round btn-middle btn-outline-info btn_enviar_solicitud"  id="Boton">Actualizar estado</button>
                                ...
                                <a href="{{url('/tramites/interior/parqueaderos')}}" class="btn btn-round btn-high">Volver</a>
