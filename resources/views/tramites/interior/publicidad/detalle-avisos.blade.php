                ...
                <div class="table-simple-headblue-govco col-md-12 animate__animated animate__bounceInRight">
                    <table class="table table-responsive-md table-responsive-md">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong>N° Caras</strong><br>
                                    {{ $detalles[0]->numero_caras }}
                                </td>
                                <td><strong>N° Elementos</strong><br>
                                    {{ $solicitud->numero_elementos }}
                                </td>

                                <td><strong>Dirección/Ubicacion</strong><br>
                                    {{ $detalles[0]->direccion_elemento }}
                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" onclick="cargarValores();">Aceptar y
                            Generar</button>
        ...
        function descargarPdf(data) {
            ...
            $.ajax({
                ...
                url: "/tramites/interior/publicidad/detalle/downoadPdf/" + publicidad_id + "/" +
                    consecutivo + "/" + fecha_consecutivo + "/" + data.valor_total_form + "/" + data
                    .fecha_inicial_parcial + "/" + data.fecha_final_parcial,
                xhrFields: {
