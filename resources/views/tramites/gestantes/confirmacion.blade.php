        ...
        <div class="row mt-2">
            ...
            <div class="col-md-12">
                ...
                <div class="alert-success-govco alert alert-dismissible fade show animate__animated animate__bounceInRight" aria-label="Alerta: caso de éxito">
                    ...
                    <p>Apreciado Ciudadano, su reporte ha sido recibido satisfactoriamente con el numero de indentificador : <strong> {{session('radicado_id')}}</strong></p>
                  </div>


            </div>
            <div class="col-md-4">
                <button style="font-size:15px;" type="button" class="btn btn-round btn-middle" name="consultar"><a href="{{URL::route('familia.finalizar')}}">Finalizar</a></button>
...
<script>
    setTimeout(function() {
      window.location.href = '/familia-lactante/finalizar';
   }, 120000);
</script>
@else

<script>
    window.location = '/familia-lactante';
</script>
