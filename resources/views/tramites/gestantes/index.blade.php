                ...
                <nav aria-label="Miga de pan" style="max-height: 20px;">
                    <ol class="breadcrumb" style="background-color: #FFFFFF;">
                        <li class="breadcrumb-item ml-3 ml-md-0">
                            <a style="color: #004fbf; font-size:14px;" class="breadcrumb-text" href="https://www.bucaramanga.gov.co" target="_blank">Inicio</a>
                        </li>
                        <li class="breadcrumb-item ">
                            <div class="image-icon">
                                <span class="breadcrumb govco-icon govco-icon-shortr-arrow" style="height: 22px;"></span>
                                <a style="color: #004fbf; font-size:14px;" class="breadcrumb-text" href="https://www.bucaramanga.gov.co/tramites/" target="_blank">Tramites y servicios</a>
                            </div>
                        </li>
                        <li class="breadcrumb-item ">
                            <div class="image-icon">
                                <span class="breadcrumb govco-icon govco-icon-shortr-arrow" style="height: 22px;"></span>
                                <p class="ml-3 ml-md-0 text-miga" style="color: #004884; font-size:14px;">Salas amigas de la familia lactante</p>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="row mt-2">
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <form action="{{ route('familia.store') }}" method="POST" id="myForm" enctype="multipart/form-data"
                        ...
                        <h3 class="headline-l-govco mt-3 pl-0">1. Datos Generales <br> <span class="small-text-govco">*Campos obligatorios</span></h3>
                        ...
                        <div class="row form-group mt-2">
                            ...
                            {{-- <div class="col-md-6 pl-1 pr-1 pt-3">
                                ...
                                <input value="{{ old('identificacion_solicitante') }}" type="text"
                                    class="form-control document_validate  @error('identificacion_solicitante') is-invalid @enderror"
                                    name="identificacion_solicitante" id="identificacion_solicitante" maxlength="15"
                                    minlength="4" required onkeypress="return Numeros(event)">
                            ...
                            {{-- <div class="col-md-12 pl-1 pt-3">
                                ...
                                <input type="text" value="{{ old('nombre_empresa') }}"
                                    ...
                                    name="nombre_empresa" id="nombre_empresa" maxlength="120" required
                                    onkeypress="return Direccion(event)" onkeyup="aMayusculas(this.value,this.id)">
                            ...
                            {{-- <div class="col-md-12 pl-1 pt-3">
                                ...
                                <label for="direccion_empresa" class="form-label">Dirección de parqueadero a
                                    categorizar. * </label><button type="button" class="btn btn-link"><span
                                        ...
                                        direccion)</span></button>
                                <input type="text" value="{{ old('direccion_empresa') }}"
                                    class="form-control  @error('direccion_empresa') is-invalid @enderror"
                                    name="direccion_empresa" id="direccion_empresa" maxlength="120" required readonly>
                            ...
                            {{-- <div class="col-md-6 pl-1 pr-1 pt-3">
                                ...
                                <input value="{{ old('tel_empresa') }}" type="text"
                                    ...
                                    name="tel_empresa" id="tel_empresa" maxlength="10" minlength="7" required
                                    onkeypress="return Numeros(event)">
                                @error('tel_empresa')
                                    <span class="invalid-feedback" role="alert">
                                        <strong class="text-danger">{{ $message }}</strong>
                            ...
                            <div class="col-md-12">
                            <h3 class="headline-l-govco mt-3 pl-0">2. Datos Especificos <br> <span class="small-text-govco">*Campos obligatorios</span></h3>
                           </div>
                           <div class="col-md-6 pl-1 pr-1 pt-3">
                        ...
                        <div class="col-md-6 pl-1 pr-1 pt-3">
                            ...
                            <div class="col-md-12 pl-1 pt-3">
                                ...
                                <label class="checkbox-govco d-inline">
                                    <input type="checkbox" id="AT01" name="acepto_terminos" value="SI" />
                                ...
                                <p class="text-justify">Confirmo que soy mayor de edad y con plena capacidad para
                                    ...
                                    <label class="checkbox-govco d-inline">
                                        <input type="checkbox" id="AT02" name="confirmo_mayorEdad" value="SI" />
                            ...
                            <div class="col-md-12  pl-1 pr-1 pt-3 text-left mt-4" style="padding-left: 0px!important">
                                ...
                                <button style="font-size:15px;" type="submit"
                                    ...
                                    onclick="return confirm('¿Esta seguro de realizar esta solicitud ?')">Enviar Reporte</button>
                            ...
                            <div id="collapse1" class="collapse" aria-labelledby="headingUno"
                                ...
                                <div class="card-body bg-color-selago">
                                    <div class="container">
                                        ...
                                        <p class="form-inline"><span
                                                class="govco-icon govco-icon-call-center"></span><a style="color: #3366CC;"
                                                href="tel:0376337000"> (+57)7 633 70 00</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body bg-color-selago">
                                    ...
                                    <div class="container text-center">
                                        ...
                                        <div id="text-button" style="padding-bottom: 10px; display: none;">
                                            ...
                                            <textarea class="form-control pb-2" rows="5" placeholder="Queremos conocer tu experiencia, sugerencias y consejos"
