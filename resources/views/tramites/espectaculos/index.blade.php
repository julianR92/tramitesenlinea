                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="card gov-co-tramite-card">
                             <a href="{{route('espectaculos.registro')}}" tabindex="9"> <div class="card-header text-center">Radicar trámite</div></a>
                              <div class="card-body">
                                 <p class="card-text">Inicie el trámite de pago en linea de espectáculos publicos.</p>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <a href="https://impuestos.bucaramanga.gov.co/Espectaculos" class="btn btn-low" rel="noopener noreferrer">Elaborar Declaración</a>
                        </div>
                     </div>
                   </div>
