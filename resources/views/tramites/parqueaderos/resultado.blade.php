        ...
        <div class="container-fluid">
            <div class="row mt-2">
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <p class="text-justify">A través de la siguiente funcionalidad podrás observar el estado actual en el que se encuentra su solicitud presentada ante la Alcaldía de Bucaramanga en el trámite de <B>CATEGORIZACION DE PARQUEADEROS</B>, depende del estado actual de su trámite podrá interactuar sobre su solicitud o ejercer acciones sobre la misma. </p>
                </div>
