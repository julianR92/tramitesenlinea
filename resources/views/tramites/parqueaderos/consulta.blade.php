                ...
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                  ...
                  <div id="section-index">
                     <div class="card govco-card border-0 shadow-none" style="border-radius: 0px;">
                        <h3 class="Headline-l">Consultar Tramites</h3>

                       <p class="text-justify">A través de la siguiente funcionalidad, consulte el estado de sus solicitudes presentadas ante la Alcaldía de Bucaramanga en el tramite de <B>CATEGORIZACION DE PARQUEADEROS</B>. La búsqueda la puede realizar diligenciando los campos dispuestos continuación:</p>
                     
                  </div>
                  <div class="row">
                     <div class="col-md-12">
                        <form method="post" action="{{route('parqueadero.consulta')}}" class="formConsultarTramite">
                    @csrf
                      <div class="row form-row">
                       ...
                       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4">
                        <div class="g-recaptcha" data-sitekey="6LdzXDwcAAAAAOgw8LzMLMjgnI2spGFhuCoMYlGc" data-tabindex="12"></div>
                       </div>
                       <div class="col-lg-12 col-md-12 d-flex justify-content-end mt-4">                   
                          <button type="submit" class="btn btn-round btn-middle btn-outline-info"  id="Boton" tabindex="13">Realizar Búsqueda</button>
                          <a href="{{route('parqueaderos.index')}}"><button type="button" class="btn btn-round btn-middle btn-outline-info"  tabindex="14">Volver</button></a>
                       </div>
                    </div>
