   ...
   <div class="container-fluid">
      <div class="row mt-2">
         <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
            ...
            <form action="/publicidad-exterior/DocPendientes" method="GET" id="frm" enctype="multipart/form-data"
               ...
               <div class="row form-group mt-2">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><br>
                     <div class="form-group">
                        ...
                        <input type="text" name="identificacion" id="identificacion" class="form-control input-md"
                           ...
                           onkeypress="return Numeros(event)" onkeyup="aMayusculas(this.value,this.id)" maxlength="40"
                           minlength="5">
                     </div>
                  </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><br>
                     <div class="form-group">
                        ...
                        <input type="text" name="Radicado" id="Radicado" class="form-control input-md"
                           title="Seleccione la opción para validar el documento" required="required" onkeypress=""
                           onkeyup="aMayusculas(this.value,this.id)" maxlength="20" minlength="20">
                     </div>
                  </div>
                  ...
                  <div class="col-md-12  pl-1 pr-1 pt-3 text-left mt-4" style="padding-left: 0px!important">
                     ...
                     <button style="font-size:15px;" type="submit"
                        ...
                        <a href="/publicidad-exterior" Style="font-size:15pt;">Volver</a><br>
