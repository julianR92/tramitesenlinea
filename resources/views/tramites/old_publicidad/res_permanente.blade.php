...
<body>
   <header>
      <div class="row">
         <div class="col-md-12">
            <img src="{{ public_path('img/RES_PERMANENTE2.png') }}" class="img-fluid" width="100%">
         </div>
      </div>
   </header>
         ...
         <div class="row">
            <ol type="A">
               <li style="text-align:justify;">En desarrollo de la ley 140 de 1994, por la cual se reglamenta la
                  ...
                  territorio nacional, se expidió el Decreto 0040 de 2022, el cual en los artículos 122 y siguientes
                  regula
                  los aspectos sobre publicidad exterior visual en el Municipio de Bucaramanga. Establece la norma
                  citada
                  que la publicidad de carácter permanente es decir aquella que se conserve por un término superior a
                  treinta (30) días y cuya dimensión es de {{ $area }} metros cuadrados causara impuesto
                  equivalente a cuatro (4) salarios mínimos legales mensuales, por año. Señala igualmente que la
                  publicidad
                  de carácter permanente y cuyas dimensiones sean superiores o inferiores a {{ $area }} metros
                  cuadrados causará un impuesto proporcional a lo establecido en el inciso anterior.
               </li>
         ...
         <div class="container-fluid" style=" display:block;page-break-before:always;">
            ...
            <div class="row">
               ...
               <div class="col-md-12">
                  ...
                  <table class="tg" width="100%">
                     <thead>
                        <tr>
                           ...
                           <td style="text-align:center;" class="tg-0pky" width="auto">CANTIDAD</td>
                           <td style="text-align:center;" class="tg-0pky" width="auto">PERIODO DE COBRO</td>
                           <td style="text-align:center;" class="tg-0pky" width="auto">No DE MESES</td>
                  ...
                  <p align="justify">
                     <strong>ARTÍCULO QUINTO:</strong> Notificar la presente resolución según los términos y
