        ...
        <div class="col-md-12 pt-4" style="padding-left: 10px!important">
            ...
            <div class="row pt-5">
                ...
                <div class="card govco-card">
                    ...
                    <div class="card-footer govco-card-footer govco-center">
                        <a class="btn-low-mix-govco align-column-govco" href="{{ route('interior.publicidad.listarSolicitudes', 'MURALES') }}">
                            <span class="btn-mix-govco__title">Ver más detalles</span>
                            <span class="btn-mix-govco__icon govco-icon govco-icon-simpled-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="card govco-card">
                    ...
                    <div class="card-footer govco-card-footer govco-center">
                        <a class="btn-low-mix-govco align-column-govco" href="{{ route('interior.publicidad.listarSolicitudes', 'PASACALLES') }}">
                            <span class="btn-mix-govco__title">Ver más detalles</span>
                            <span class="btn-mix-govco__icon govco-icon govco-icon-simpled-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="card govco-card">
                    ...
                    <div class="card-footer govco-card-footer govco-center">
                        <a class="btn-low-mix-govco align-column-govco" href="{{ route('interior.publicidad.listarSolicitudes', 'PUBLICIDAD AEREA') }}">
                            <span class="btn-mix-govco__title">Ver más detalles</span>
                            <span class="btn-mix-govco__icon govco-icon govco-icon-simpled-arrow"></span>
                        </a>
                    </div>
                ...
                <div class="card govco-card">
                    ...
                    <div class="card-footer govco-card-footer govco-center">
                        <a class="btn-low-mix-govco align-column-govco" href="{{ route('interior.publicidad.listarSolicitudes', 'PENDONES') }}">
                            <span class="btn-mix-govco__title">Ver más detalles</span>
                            <span class="btn-mix-govco__icon govco-icon govco-icon-simpled-arrow"></span>
                        </a>
                    </div>
