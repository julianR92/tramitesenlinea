                ...
                <div style="" class="table-simple-headblue-govco col-md-12 animate__animated animate__bounceInRight">              
                    ...
                    <tbody>
						<tr>
							...
							<td colspan="2"><strong>Tipo de solicitud:</strong><br>Recibo de areas de cesión públicas obligatorias y cesiones
							 tipo A en procesos de legalización de asentamientos humanos.
							</td>    
						</tr>
						<tr>
						...
						<tr>
							...
							<td><strong>Identificación Catastral:</strong><br>

								@if($solicitud->PredioLicencia == null || $solicitud->PredioLicencia == '' )
									<small>No hay # de identificación catastral.</small>
								   @else
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="form-group">
                                ...
                                <a href="{{url('/tramites/DadepAdmin/Cesion/B')}}" class="btn btn-round btn-high">Volver</a>
