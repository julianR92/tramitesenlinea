                ...
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <div id="section-index">
                        <div class="card govco-card border-0 shadow-none" style="border-radius: 0px;">
                            ...
                            <p style="text-align: justify"> Este tramite es la Autorización para valoración por equipo multidisciplinario- Procedimiento certificación de discapacidad ( Resolución 1197 de 2024) <a href="{{asset('library/Manuales/resolucion 1197 de 2024.pdf')}}" target="_blank">Ver</a> </p>
                        </div>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="card gov-co-tramite-card">
                                <a href="{{route('discapacidad.registro')}}" tabindex="9"> <div class="card-header text-center">Radicar trámite</div></a>
                                 <div class="card-body">
                                    <p class="card-text">Inicie el trámite de autorización de la certificación de discapacidad.</p>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                    ...
                    <div class="row form-row">
                       ...
                       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><br>
                          <div class="form-group">
                            ...
                            <input type="text" name="parametro" id="VD00" class="form-control input-md" title="Digite Numero" required="required" onkeypress="return Numeros(event)" onkeyup="aMayusculas(this.value,this.id)" maxlength="40" minlength="5" tabindex="12">
