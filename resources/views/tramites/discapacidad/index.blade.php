        ...
        <div class="container-fluid">
            <div class="row mt-2">
                <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                    ...
                    <form action="{{route('discapacidad.store')}}" method="POST" id="myForm" enctype="multipart/form-data" class="form-ciudadano">
                        @csrf
                    ...
                    @endif 
                        ...
                        <h3 class="headline-l-govco mt-3 pl-0">1. Datos del responsable de la solicitud</h3>
                        ...
                        <div class="row form-group mt-2">
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                                ...
                                <input value="{{old('nom_responsable')}}" type="text" class="form-control name_validate  @error('nom_responsable') is-invalid @enderror" name="nom_responsable" id="nom_responsable"  maxlength="25" minlength="4" required onkeypress="return Letras(event)" onkeyup="aMayusculas(this.value,this.id)">
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                                ...
                                <input value="{{old('ape_responsable')}}" type="text" class="form-control name_validate  @error('ape_responsable') is-invalid @enderror" name="ape_responsable" id="ape_responsable"  maxlength="25" minlength="4" required onkeypress="return Letras(event)" onkeyup="aMayusculas(this.value,this.id)" >
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                               ...
                               <input value="{{old('ide_responsable')}}" type="text" class="form-control document_validate  @error('ide_responsable') is-invalid @enderror" name="ide_responsable" id="ide_responsable"  maxlength="15" minlength="4" required onkeypress="return Numeros(event)" >
                              ...
                              <div class="col-md-6 pl-1 pr-1 pt-3">
                                 ...
                                 <input value="{{old('tel_responsable')}}" type="text" class="form-control  @error('tel_responsable') is-invalid @enderror number_validate" name="tel_responsable" id="tel_responsable"  maxlength="10" minlength="7" required onkeypress="return Numeros(event)" >
                              ...
                              <div class="col-md-12">                                 
                              <h3 class="headline-l-govco mt-3 pl-0">2. Datos del Ciudadano</h3>
                              </div>
                           ...
                           <div class="col-md-6 pl-1 pr-1 pt-3">
                                ...
                                <select class="form-control  @error('tipo_identificacion_sol') is-invalid @enderror" name="tipo_identificacion_sol" id="tipo_identificacion_sol" required>
                            ...
                            <div class="col-md-6 pl-1 pr-1 pt-3">
                              ...
                              <input value="{{old('ide_solicitante')}}" type="text" class="form-control document_validate  @error('ide_solicitante') is-invalid @enderror" name="ide_solicitante" id="ide_solicitante"  maxlength="15" minlength="4" required onkeypress="return Numeros(event)" >
                             ...
                             <div class="col-md-6 pl-1 pr-1 pt-3">
                              ...
                              <input value="{{old('correo_solicitante')}}" type="mail" class="form-control  @error('correo_solicitante') is-invalid @enderror email_validate" name="correo_solicitante" id="correo_solicitante">
                          ...
                          <div class="col-md-6 pl-1 pr-1 pt-3">
                           ...
                           <input value="{{old('tel_solicitante')}}" type="text" class="form-control  @error('tel_solicitante') is-invalid @enderror tel_solicitante" name="tel_solicitante" id="tel_solicitante"  maxlength="10" minlength="7" onkeypress="return Numeros(event)" >
                           ...
                           @enderror
                            ...
                            <div class="col-md-12 pl-1 pt-3">
                                ...
                                <label for="direccion_solicitante" class="form-label">Dirección o Nomenclatura del Ciudadano* </label><button type="button" class="btn btn-link"><span style="text-transform: lowercase; font-size: 12px;" class="text-primary" data-toggle="modal" data-target="#ModalDirecciones">(Clic para insertar direccion)</span></button>
                            ...
                            <a class="btn btn-low px-0" href="https://www.bucaramanga.gov.co/wp-content/uploads/2018/12/Resolucion-340-Dic-26-2018-y-Politica.pdf" target="_blank">Acepto términos y condiciones</a>
                            <label class="checkbox-govco d-inline">
