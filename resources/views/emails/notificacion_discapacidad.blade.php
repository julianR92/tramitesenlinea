...
<title>Autorización de la certificación de la discapacidad</title>
		...
		<tr>
			<td style="padding: 10px 0 10px 0;">
				...
				<td style="padding: 10px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                    ...
                    <p align="justify">Cordial saludo,  <strong> {{$detalleCorreo['nombres']}} </strong> .

						<p align="justify">Usted ha realizado una solicitud para la Autorización de la certificación de discapacidad, si desea realizar alguna consulta sobre el estado de la solicitud diríjase a la pagina <a href="https://tramitesenlinea.bucaramanga.gov.co/certificado-discapacidad"> https://tramitesenlinea.bucaramanga.gov.co/certificado-discapacidad </a> Con el numero de radicado <strong>{{$detalleCorreo['radicado']}}</strong> opción <u>consulto mi solicitud</u>. o dando clic en el siguiente enlace.<a href="https://tramitesenlinea.bucaramanga.gov.co/certificado-discapacidad/detalle/{{$detalleCorreo['id']}}">Clic aquí</a></p>

						<p align="justify">Si tiene alguna inquietud referente a la solicitud favor comunicarse al correo <a href="mailto:laquinonez@bucaramanga.gov.co">laquinonez@bucaramanga.gov.co</a> y realizar la observación o comunicarse al número telefónico <a href="tel:6076337000">6076337000</a>EXT 184</p>                       
					...
					<p align="justify">Por favor dirijase a la siguiente url<a href="http://tramitesenlinea.bucaramanga.gov.co/" target="_blank"> http://tramitesenlinea.bucaramanga.gov.co/ </a> e ingrese sus credenciales</p>
                    ...
                    <p align="justify">Cordial saludo,  <strong> {{$detalleCorreo['nombres']}} </strong> .<p>
                     ...
                     <p align="justify">{{ $detalleCorreo['mensaje']}}</p>
					   ...
					   <p align="justify">Nos permitimos recordarle que cuenta hasta el <strong>{{$detalleCorreo['fecha_pendiente']}} para cargar los documentos nuevamente.</strong> Para volver adjuntar los documentos diríjase a la página <a href="https://tramitesenlinea.bucaramanga.gov.co/certificado-discapacidad" target="_blank"> https://tramitesenlinea.bucaramanga.gov.co/certificado-discapacidad </a> opción <u>consulto mi solicitud, botón detalle</u>. o ingrese al siguiente link <a href="https://tramitesenlinea.bucaramanga.gov.co/certificado-discapacidad/detalle/{{$detalleCorreo['id']}}"> Clic aqui</a></p>
