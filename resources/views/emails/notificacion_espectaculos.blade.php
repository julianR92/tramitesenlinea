			...
			<td style="padding: 10px 0 10px 0;">
				...
				<td style="padding: 10px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                    ...
                    <p align="justify">Cordial saludo,  <strong> {{$detalleCorreo['nombres']}} </strong> .<p>
						...
						<p align="justify">Usted ha realizado una solicitud para la la realización de un espectaculo publico, recuerde acercar de manera fisica la garantia del evento, si desea realizar alguna consulta sobre el estado de la solicitud diríjase a la pagina <a href="https://tramitesenlinea.bucaramanga.gov.co/espectaculos-publicos"> https://tramitesenlinea.bucaramanga.gov.co/espectaculos-publicos </a> Con el numero de radicado <strong>{{$detalleCorreo['radicado']}}</strong> opción <u>consulto mi solicitud</u> o haga clic en el siguiente enlace.<a href="http://tramitesenlinea.test/espectaculos-publicos/detalle/{{$detalleCorreo['id']}}">Clic aquí</a></p>
                    ...
                    <p align="justify">Cordial saludo,  <strong> {{$detalleCorreo['nombres']}} </strong> .<p>
                     ...
                     <p align="justify">{{ $detalleCorreo['mensaje']}}</p>
					   ...
					   <p align="justify">Nos permitimos recordarle que cuenta hasta el <strong>{{$detalleCorreo['fecha_pendiente']}} para cargar los documentos nuevamente o acercar la garantia fisicamente.</strong> Para volver adjuntar los documentos diríjase a la página <a href="https://tramitesenlineapruebas.bucaramanga.gov.co/espectaculos-publicos" target="_blank">"https://tramitesenlinea.bucaramanga.gov.co/espectaculos-publicos </a> opción <u>consulto mi solicitud, botón detalle</u>. o ingrese al siguiente link <a href="http://tramitesenlinea.test/espectaculos-publicos/detalle/{{$detalleCorreo['id']}}"> Clic aquí</a> Tenga en cuenta que si tiene que reponer la garantía <strong> DEBE HACERLO DE MANERA FISICA(PRESENCIAL)</strong></p>
