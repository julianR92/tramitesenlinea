...
<title>Permisos para Espectáculos Públicos</title>
			...
			<td style="padding: 10px 0 10px 0;">
				...
				<td style="padding: 10px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                    ...
                    <p align="justify">Cordial saludo,  <strong> {{$detalleCorreo['nombres']}} </strong> .<p>
						...
						<p align="justify">Usted ha realizado una solicitud de permiso para espectaculos públicos, si desea realizar alguna consulta sobre el estado de la solicitud diríjase a la pagina <a href="https://tramitesenlinea.bucaramanga.gov.co/eventos-publicos">https://tramitesenlinea.bucaramanga.gov.co/eventos-publicos</a> con el numero de radicado <strong>{{$detalleCorreo['radicado']}}</strong> opción <u>consulto mi solicitud</u>.</p>

						<p align="justify">Si tiene alguna inquietud referente a la solicitud favor comunicarse al correo <a href="mailto:ccalderon@bucaramanga.gov.co">ccalderon@bucaramanga.gov.co</a> y realizar la observación o comunicarse al número telefónico <a href="tel:6337000">6337000</a>ext. 315</p>  
					...
					@elseif ($detalleCorreo['estado'] == 'FUNCIONARIO')
						...
						<p align="justify">{{ $detalleCorreo['mensaje']}}<a href="https://tramitesenlinea.bucaramanga.gov.co/" target="_blank">https://tramitesenlinea.bucaramanga.gov.co/</a>
                    ...
                    <p align="justify">Cordial saludo,  <strong> {{$detalleCorreo['nombres']}} </strong> .<p>
                     ...
                     <p align="justify">{{ $detalleCorreo['mensaje']}}</p>
					   ...
					   <p align="justify">Nos permitimos recordarle que cuenta hasta el <strong>{{$detalleCorreo['fecha_pendiente']}} para cargar los documentos nuevamente.</strong> Para volver adjuntar los documentos diríjase a la página <a href="https://tramitesenlinea.bucaramanga.gov.co/eventos-publicos" target="_blank">https://tramitesenlinea.bucaramanga.gov.co/eventos-publicos</a> opción <u>consulto mi solicitud, botón detalle</u> ó ingresando al siguiente link <a href="https://tramitesenlinea.bucaramanga.gov.co/eventos-publicos/detalle/{{$detalleCorreo['id']}}"> Clic aqui</a></p>
