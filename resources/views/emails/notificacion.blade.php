			...
			<td style="padding: 10px 0 10px 0;">
				<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
					<tr>
						...
						<img src="https://emergencia.bucaramanga.gov.co/Frame/img/Asset_full.png" height="40" alt="Logo Alcaldia Bga" style="float: left; padding-top: 15px; padding-bottom:10px; padding-left:8px;"/>
				...
				<td style="padding: 10px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                    ...
                    <h3 align="justify">Solicitud No {{$detalleCorreo['radicado']}} en estado {{$detalleCorreo['estado']}}.<br></h3>
                    <p align="justify">Cordial saludo,  <strong> {{$detalleCorreo['nombres']}} </strong> .<p>
                     ...
                     <p align="justify">Nos permitimos recordarle que cuenta hasta el <strong>{{$detalleCorreo['fecha_pendiente']}} para cargar los documentos nuevamente.</strong> Para volver adjuntar los documentos diríjase a la página <a href="https://ocupacionespaciopublico.bucaramanga.gov.co/" target="_blank"> https://ocupacionespaciopublico.bucaramanga.gov.co/ </a> opción <u>consulto mi solicitud</u>.</p>
                                              
                     @endif

                     <p align="justify">si tiene alguna inquietud referente a la solicitud favor comunicarse con los canales oficiales de atención al ciudadano <a href="https://pqr.bucaramanga.gov.co/">PQRSD</a> y realizar la observación o comunicarse al número telefónico <a href="tel:6337000">6337000</a> ext. 454</p>                       
