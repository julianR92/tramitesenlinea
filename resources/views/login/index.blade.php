...
<div class="container pt-3">
    <div class="row justify-content-center">      
      ...
      <div class="form-group"><br>
        ...
        <input type="text" class="form-control input-govco @error('username') is-invalid @enderror" maxlength="10" id="username" name="username" value="{{old('username')}}" onkeypress="return Letras(event)" required autofocus>
        @error('username')
