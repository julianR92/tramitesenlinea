            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $("#PersonaBarrio").val(response.persona.PersonaBarrio).trigger("change");
                        ...
                        doc.getElementById("divInfo").classList.remove(
                            "d-none"
                        );
                        $("#loadMe").modal("hide");
                    } else {
    ...
    doc.addEventListener("change", (e) => {
        ...
        if (e.target.matches("#publicidad_modalidad")) {
            ...
            if (modalidad) {
                $.ajax({
                    url:
                        "/publicidad-exterior/solicitud/modalidad/" + modalidad,
                    type: "GET",
                    success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        setInterval(() => {
                            window.location.href =
                                "/publicidad-exterior/solicitud/" +
                                response.persona.PersonaDoc;
                        }, 2000);
                    } else {
                        $("#loadMe").modal("hide");
